import { c as createComponent, r as renderTemplate, m as maybeRenderHead, h as renderSlot, i as defineScriptVars, b as createAstro, a as addAttribute, s as spreadAttributes, d as renderComponent, j as renderHead } from './astro/server_CT4WjY02.mjs';
import 'kleur/colors';
/* empty css                         */
import 'clsx';

const $$Container = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${maybeRenderHead()}<div class="max-w-screen-2xl mx-auto px-8 lg:px-10 xl:px-12"> ${renderSlot($$result, $$slots["default"])} </div>`;
}, "/Users/siyargulmez/visible-velocity/src/components/Container.astro", void 0);
...
}, "/Users/siyargulmez/visible-velocity/node_modules/astro-navbar/src/Astronav.astro", void 0);
...
}, "/Users/siyargulmez/visible-velocity/node_modules/astro-navbar/src/components/MenuIcon.astro", void 0);
...
}, "/Users/siyargulmez/visible-velocity/node_modules/astro-navbar/src/components/OpenIcon.astro", void 0);
...
}, "/Users/siyargulmez/visible-velocity/node_modules/astro-navbar/src/components/CloseIcon.astro", void 0);
...
}, "/Users/siyargulmez/visible-velocity/node_modules/astro-navbar/src/components/MenuItems.astro", void 0);
...
}, "/Users/siyargulmez/visible-velocity/node_modules/astro-navbar/src/components/Dropdown.astro", void 0);
...
}, "/Users/siyargulmez/visible-velocity/node_modules/astro-navbar/src/components/DropdownSubmenu.astro", void 0);
...
}, "/Users/siyargulmez/visible-velocity/node_modules/astro-navbar/src/components/DropdownItems.astro", void 0);
...
}, "/Users/siyargulmez/visible-velocity/node_modules/astro-navbar/src/components/StickyHeader.astro", void 0);
...
const $$Navbar = createComponent(($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Navbar;
  const menuitems = [
    { href: "/about", label: "Unsere Mission" },
    { href: "/bewerber", label: "F\xFCr Bewerber" },
    { href: "/unternehmen", label: "F\xFCr Unternehmen" },
    // Link points to /untern
    { href: "/pricing", label: "Offene Positionen" },
    { href: "/articles", label: "Aktuelle Themen" }
  ];
  const navButton = { href: "https://docs.google.com/forms/d/e/1FAIpQLSfAv1b7wiozjBvVMwfzk8jOXinqDolvzVhFQcW18D9769K4aQ/viewform?embedded=true", label: "Kontaktiere uns in 2 Minuten" };
  return renderTemplate`${maybeRenderHead()}<div class="mt-20"> <nav class="w-full top-0 left-0 z-50 fixed bg-white"> ${renderComponent($$result, "Container", $$Container, {}, { "default": ($$result2) => renderTemplate` <header class="flex flex-col lg:flex-row justify-between items-center my-5"> ${renderComponent($$result2, "Astronav", $$Astronav, {}, { "default": ($$result3) => renderTemplate` <div class="flex w-full lg:w-auto items-center justify-between"> <a href="/" class="flex items-center space-x-3 rtl:space-x-reverse"> <!-- Lime box behind logo --> <div class="bg-lime p-2"> <img src="/Logo3.svg" class="h-16" alt="Logo"> </div> </a> <div class="block lg:hidden"> ${renderComponent($$result3, "MenuIcon", $$MenuIcon, { "class": "w-8 h-8 text-black" })} </div> </div> ${renderComponent($$result3, "MenuItems", $$MenuItems, { "class": "hidden w-full lg:w-auto mt-2 lg:flex lg:mt-0" }, { "default": ($$result4) => renderTemplate` <ul class="font-medium flex flex-col p-4 lg:p-0 mt-4 border rounded-lg lg:flex-row lg:space-x-8 lg:mt-0 lg:border-0"> ${menuitems.map((item, index) => renderTemplate`<li> <a${addAttribute(item.href, "href")} class="block py-2 px-3 text-black rounded lg:bg-transparent lg:p-0">${item.label}</a> </li>`)} <div class="lg:hidden flex items-center justify-center mt-3 gap-4"> <a class="px-9 py-5 rounded-2xl border border-zinc-900 bg-white hover:bg-black text-black hover:text-white inline-flex"${addAttribute(navButton.href, "href")} target="_blank"><h2 class="text-center text-xl font-normal leading-7">${navButton.label}</h2> </a> </div> </ul> ` })} ` })} <div> <div class="hidden lg:flex items-center gap-4"> <a class="px-9 py-5 rounded-2xl border border-zinc-900 bg-white hover:bg-lime text-black hover:text-black inline-flex"${addAttribute(navButton.href, "href")} target="_blank"><h2 class="text-center text-xl font-normal leading-7">${navButton.label}</h2> </a> </div> </div> </header> ` })} </nav> </div>`;
}, "/Users/siyargulmez/visible-velocity/src/components/Navbar.astro", void 0);
...
const $$Footer = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate(_a || (_a = __template(["", '<footer class="bg-lime bg-fixed bg-bottom text-black"> ', ' </footer> <script>\n    const year = new Date().getFullYear();\n    document.getElementById("currentYear").innerHTML = `${year}`;\n<\/script>'], ["", '<footer class="bg-lime bg-fixed bg-bottom text-black"> ', ' </footer> <script>\n    const year = new Date().getFullYear();\n    document.getElementById("currentYear").innerHTML = \\`\\${year}\\`;\n<\/script>'])), maybeRenderHead(), renderComponent($$result, "Container", $$Container, {}, { "default": ($$result2) => renderTemplate` <div class="py-6"> <div class="flex flex-col items-center justify-between md:flex-row"> <div class="flex items-center space-x-3 rtl:space-x-reverse"> <img class="h-21" src="/Logo3.svg" alt="Logo"> </div> <div class="flex mt-4 md:m-0"> <div class="-mx-4">
@ <span id="currentYear"></span> Ångestellt | Made with <a href="https://astro.build/" target="_blank" rel="noopener noreferrer" class="underline">Passion</a> </div> </div> </div> <!-- Add the Impressum link here --> <div class="text-center mt-4"> <a href="/impressum" class="underline text-black hover:text-gray-700">Impressum</a> </div> </div> ` }));
}, "/Users/siyargulmez/visible-velocity/src/components/Footer.astro", void 0);
...
}, "/Users/siyargulmez/visible-velocity/node_modules/astro/components/ViewTransitions.astro", void 0);

const $$Astro = createAstro();
const $$Layout = createComponent(($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro, $$props, $$slots);
  Astro2.self = $$Layout;
  return renderTemplate`<html lang="en"> <head><meta charset="UTF-8"><meta name="description" content="Astro description"><meta name="viewport" content="width=device-width"><link rel="icon" type="image/svg+xml" href="/favicon.svg"><meta name="generator"${addAttribute(Astro2.generator, "content")}><title>Ångestellt</title><meta name="u liebst Wasser? Wir finden den passenden Job der dich glücklich macht" content="Unser Recruiting Team hilft dir deinen perfekten Job zu finden und das - kostenlos!"><link href="https://fonts.googleapis.com/css2?family=Space+Grotesk:wght@300..700&display=swap" rel="stylesheet">${renderComponent($$result, "ViewTransitions", $$ViewTransitions, {})}${renderHead()}</head> <body class="bg-white font-SpaceGrotesk"> ${renderComponent($$result, "Navbar", $$Navbar, {})} ${renderSlot($$result, $$slots["default"])} ${renderComponent($$result, "Footer", $$Footer, {})} </body></html>`;
}, "/Users/siyargulmez/visible-velocity/src/layouts/Layout.astro", void 0);
